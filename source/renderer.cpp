...
ComPtr<ID3D12Resource> RendererState::m_AtmosphereRenderTarget;
CD3DX12_CPU_DESCRIPTOR_HANDLE RendererState::m_AtmosphereRtvHandle;
CD3DX12_GPU_DESCRIPTOR_HANDLE RendererState::m_AtmosphereSrvHandle;
