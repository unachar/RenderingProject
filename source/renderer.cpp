...
ComPtr<ID3D12Resource> RendererState::m_PostProcessRenderTarget;
ComPtr<ID3D12Resource> RendererState::m_PreUpscaleAaRenderTarget;
ComPtr<ID3D12Resource> RendererState::m_PreUpscaleAaHistory;
ComPtr<ID3D12Resource> RendererState::m_EditorSceneRenderTarget;
ComPtr<ID3D12Resource> RendererState::m_TransparentSceneCopy;
ComPtr<ID3D12DescriptorHeap> RendererState::m_SceneRtvHeap;
CD3DX12_CPU_DESCRIPTOR_HANDLE RendererState::m_SceneRtvHandle;
CD3DX12_CPU_DESCRIPTOR_HANDLE RendererState::m_PostProcessRtvHandle;
CD3DX12_CPU_DESCRIPTOR_HANDLE RendererState::m_PreUpscaleAaRtvHandle;
...
CD3DX12_GPU_DESCRIPTOR_HANDLE RendererState::m_PostProcessSrvHandle;
CD3DX12_GPU_DESCRIPTOR_HANDLE RendererState::m_PreUpscaleAaSrvHandle;
CD3DX12_GPU_DESCRIPTOR_HANDLE RendererState::m_PreUpscaleAaHistorySrvHandle;
CD3DX12_GPU_DESCRIPTOR_HANDLE RendererState::m_EditorSceneSrvHandle;
CD3DX12_GPU_DESCRIPTOR_HANDLE RendererState::m_EditorSceneUavHandle;
CD3DX12_GPU_DESCRIPTOR_HANDLE RendererState::m_TransparentSceneSrvHandle;
...
ComPtr<ID3D12PipelineState> RendererState::m_VelocityPso;
ComPtr<ID3D12PipelineState> RendererState::m_VelocityGeometryPso;
